...
This compatibility path passes local regression tests; live multi-message behavior remains unverified. For new installations use the main onboarding guide and authorized API credentials.
